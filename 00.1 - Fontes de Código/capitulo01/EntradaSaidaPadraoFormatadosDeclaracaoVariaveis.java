/* 
 * Arquivo: capitulo01/EntradaSaidaPadraoFormatadosDeclaracaoVariaveis.java
 * Autor: Prof. Dr. David Buzatto
 */

public class EntradaSaidaPadraoFormatadosDeclaracaoVariaveis {
    ...
    public static void main( String[] args ) {
        ...
        double altura;            // variável decimal chamada altura
        ...
        double peso = 90.5;       // variável decimal chamada peso
